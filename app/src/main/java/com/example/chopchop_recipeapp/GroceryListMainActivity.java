...
public class GroceryListMainActivity extends AppCompatActivity {
   ...
   GroceryAdapter myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter = new GroceryAdapter( getMyList());
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(GroceryListMainActivity.this, AdditemsToList.class));
            }
        });
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                AlertDialog.Builder builder = new AlertDialog.Builder(GroceryListMainActivity.this);
    ...
    private ArrayList<List> getMyList(){
        ...
        dbRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                myAdapter = new GroceryAdapter(allList);
                recyclerview.setAdapter(myAdapter);
