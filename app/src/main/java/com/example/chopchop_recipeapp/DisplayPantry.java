...
public class DisplayPantry extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    Pantry data = dataSnapshot.getValue(Pantry.class);
                     Log.d("DisplayPantry","datax"+data);
   ...
   new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT) {
       ...
       public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
           AlertDialog.Builder builder = new AlertDialog.Builder(com.example.chopchop_recipeapp.DisplayPantry.this);
       ...
       public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
           new RecyclerViewSwipeDecorator.Builder(com.example.chopchop_recipeapp.DisplayPantry.this,c,recyclerView,viewHolder,dX,dY,actionState,isCurrentlyActive)

                   .addSwipeRightBackgroundColor(ContextCompat.getColor(com.example.chopchop_recipeapp.DisplayPantry.this,R.color.swipeColor))
                   .addSwipeRightActionIcon(R.drawable.ic_baseline_delete_sweep_24)
                   .addSwipeRightLabel("Delete item")
                   .addBackgroundColor(ContextCompat.getColor(com.example.chopchop_recipeapp.DisplayPantry.this,R.color.swipeColor))
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(com.example.chopchop_recipeapp.DisplayPantry.this, MainActivity.class);
