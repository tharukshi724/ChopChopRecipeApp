...
public class PantryInsert extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialog = new DatePickerDialog(PantryInsert.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                try {
                    if (TextUtils.isEmpty(eItem.getText().toString()))
                       ...
                       pantry.setItem(eItem.getText().toString().trim());
                        ...
                        Intent intent = new Intent(PantryInsert.this, DisplayPantry.class);
